...
for i, file in enumerate(filenames):
    ...
    values = np.concatenate(([ratio], occurrences.flatten(), avg_locations.flatten(), avg_locations_sq.flatten()))  # create one large numpy array with all numerical values (1D)
